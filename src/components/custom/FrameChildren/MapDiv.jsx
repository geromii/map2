...
const MapDivComponent = ({ mapMode }) => {
  ...
  return (
    <div
      ref={mapRef}
      className="relative map-container w-full h-full select-none transition drop-shadow-lg"
    >
            <div
      ...
      <div className="relative bg-slate-500 shadow-lg rounded-b-lg overflow-hidden">
                    ...
                    {remainingCountries.map((geo) => {
                      ...
                      return (
                        <Geography
                          ...
                          stroke="#334155"
                          strokeWidth={activeCountry == geo.properties.name ? 1.3 : 0.4 }
                          style={{
                            default: {
