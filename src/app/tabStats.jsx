...
const NoCountrySelected = ({ pageMode = "single", phase2Exists, phase3Exists }) => {
  return pageMode === "single" ? (
    ...
    <div className="flex justify-around  w-full translate-y-5 text-lg  drop-shadow transition">
      ...
      className="flex p-2 bg-blue-500 rounded-full  font-medium items-center text-base data-[phase2exists=true]:opacity-0 transition-opacity delay-400 duration-200">
        <IconArrowBigDownLinesFilled
          size={22}
      ...
      className="flex p-2 bg-red-500 rounded-full  font-medium items-center text-base data-[phase3exists=true]:opacity-0 transition-opacity delay-400 duration-200">
        <IconArrowBigDownLinesFilled
          size={22}
          className="text-primary drop-shadow-lg"
        />{" "}
