...
export default function HeadlinesPage() {
  ...
  if (issueScoresQuery && selectedIssueId) {
    ...
    if (currentScoreCount !== issueScoresQuery.length && issueScoresQuery.length > 0) {
            ...
            <div className="bg-slate-100 border-b border-slate-200 px-6 py-4">
              ...
              <div className="flex items-center gap-4 mt-1 text-sm">
                <span className="flex items-center gap-1.5">
                  ...
                  {selectedIssue.sideA.description && (
                    <span className="text-slate-500">({selectedIssue.sideA.description})</span>
                  )}
                </span>
                <span className="text-slate-400">vs</span>
                <span className="flex items-center gap-1.5">
                  ...
                  {selectedIssue.sideB.description && (
                    <span className="text-slate-500">({selectedIssue.sideB.description})</span>
                  )}
                </span>
              </div>
            </div>
