...
export default function HeadlineDetailPage() {
  const params = useParams();
  const slug = params.slug as string;

  // Fetch headline by slug
  ...
  useEffect(() => {
    if (headlineScoresQuery && headline) {
